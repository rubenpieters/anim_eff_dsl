...
exportPictureToFormat :: (FilePath -> Image PixelRGB8 -> IO ()) -- ^ function that saves an intermediate representation to a format. Written with writeXY from Codec.Picture in mind
