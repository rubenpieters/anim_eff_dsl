...
To inspect animations we instantiate animations with \hs{Const}. It wraps an \hs{a} value and has a \hs{b} phantom type parameter to trivially make it a functor.
