...
The \hs{sequential} function used earlier is a specialization of the \hs{liftA2} function. It does not require a \hs{a}~\hs{->}~\hs{b}~\hs{->}~\hs{c} function, and is only applicable to animations return a trivial value of type \hs{()}.
