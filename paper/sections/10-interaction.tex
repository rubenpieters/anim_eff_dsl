...
expressiveness and inspectability with a custom combinator. This feature is \emph{opt-in}, meaning that this additional work is only required when inspectability is required. If that is no concern, then it suffices to work with the \hs{Monad} constraint.
