...
expressiveness and inspectability with a custom combinator. This feature is \emph{opt-in} in that it is only required when inspectability is required. If that is no concern, then it is no problem to work with the \hs{Monad} constraint.
