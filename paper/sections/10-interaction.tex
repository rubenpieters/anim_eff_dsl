...
We revisit the \hs{onlyDone} animation from Section~\ref{sec:customcomb}. The definition using \hs{do}-notation imposes a \hs{Monad} constraint on \hs{f}, making the animation non-inspectable.
