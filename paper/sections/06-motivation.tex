...
The \hs{basic}, \hs{seq}, and \hs{par} operations form the basis for expressing a variety of animations. However, sometimes we need different operations to express our animation. For example, the animation in Figure TODO requires a variety of extra features: randomness, creation and deletion, and setting values within the world. Rather than predicting which operations users will need, the DSL provides the possibility of embedding custom operations.
